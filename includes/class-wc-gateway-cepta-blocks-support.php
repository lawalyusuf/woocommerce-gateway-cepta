...
final class WC_Gateway_Cepta_Blocks_Support extends AbstractPaymentMethodType
{
	...
	public function is_active()
	{
		...
		return $payment_gateways['cepta']->is_available();
	}
	...
	{
		$script_asset_path = plugins_url('/assets/js/blocks/frontend/blocks.asset.php', WC_CEPTA_MAIN_FILE);
		$script_asset      = file_exists($script_asset_path)
			? require $script_asset_path
			: array(
				'dependencies' => array(),
				'version'      => WC_CEPTA_VERSION,
			);
	...
	public function get_payment_method_data()
	{
		$payment_gateways_class = WC()->payment_gateways();
		$payment_gateways       = $payment_gateways_class->payment_gateways();
		$gateway                = $payment_gateways['cepta'];
		...
		return array(
			...
			'logo_url'          => array($payment_gateways['cepta']->get_logo_url()),
		);
	}
