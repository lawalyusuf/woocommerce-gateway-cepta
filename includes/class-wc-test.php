 ...
 */
function cep_wc_hydrogen_init()
{

    load_plugin_textdomain('woo-hydrogen', false, plugin_basename(dirname(__FILE__)) . '/languages');

    if (!class_exists('WC_Payment_Gateway')) {
        add_action('admin_notices', 'cep_wc_hydrogen_wc_missing_notice');
        return;
    }

    add_action('admin_init', 'cep_wc_hydrogen_testmode_notice');
    ...
    add_filter('woocommerce_payment_gateways', 'cep_wc_add_hydrogen_gateway', 99);

    add_filter('plugin_action_links_' . plugin_basename(__FILE__), 'cep_woo_hydrogen_plugin_action_links');
}
add_action('plugins_loaded', 'cep_wc_hydrogen_init', 99);
 ...
 * @return array
 **/
function cep_woo_hydrogen_plugin_action_links($links)
{
 ...
 * @return array
 */
function cep_wc_add_hydrogen_gateway($methods)
{
...
function cep_wc_hydrogen_wc_missing_notice()
{
 ...
 **/
function cep_wc_hydrogen_testmode_notice()
{
 ...
 */
function cep_wc_gateway_hydrogen_woocommerce_block_support()
{
...
add_action('woocommerce_blocks_loaded', 'cep_wc_gateway_hydrogen_woocommerce_block_support');
